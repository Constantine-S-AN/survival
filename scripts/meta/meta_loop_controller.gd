...
func debug_get_snapshot() -> Dictionary:
	...
	return {
		...
		"restaurant_service_button_tooltip": String(restaurant_model.get("service_button_tooltip", "")),
		"restaurant_service_status_text": String(restaurant_view_snapshot.get("service_status_text", restaurant_model.get("service_status_text", ""))),
		"restaurant_service_summary_text": String(restaurant_view_snapshot.get("service_summary_text", restaurant_model.get("service_summary_text", ""))),

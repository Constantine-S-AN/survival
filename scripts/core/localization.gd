...
const UI_TEXT := {
	...
	"meta.world.night_cue_ready": {"en": "Dock beacon lit. Night combat is ready whenever you step onto the pier.", "zh_CN": "码头信标已经点亮。只要踏上栈桥，就能立刻进入夜间战斗。"},
	"meta.world.night_confirm_title": {"en": "Night Dock", "zh_CN": "夜间码头"},
	"meta.world.night_confirm_ready": {"en": "The skiff is tied up and the beacon is live. Step onto the pier to launch the night run from here.", "zh_CN": "小艇已经系好，信标也已经亮起。现在从这里踏上栈桥，就会直接进入夜间行动。"},
	"meta.world.night_confirm_launch": {"en": "Board the Skiff", "zh_CN": "登上小艇"},
	"meta.world.night_confirm_cancel": {"en": "Stay in Town", "zh_CN": "先留在镇上"},
	"meta.world.night_transition_title": {"en": "Leaving Harbor", "zh_CN": "离开港口"},
	"meta.world.night_transition_body": {"en": "The skiff pushes off and the harbor lights fall behind.", "zh_CN": "小艇离开栈桥，港口灯火逐渐退到身后。"},
	...
	"meta.day_hud.departure_ready": {"en": "Night dock ready · Beacon lit", "zh_CN": "夜间码头已开放 · 信标已点亮"},

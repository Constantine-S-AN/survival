...
const UI_TEXT := {
	...
	"meta.farm.subtitle": {"en": "Spend stamina to grow supplies.", "zh_CN": "消耗体力来培育补给。"},
	...
	"meta.farm.action_detail": {"en": "Yield {yield} · Cost {cost} stamina", "zh_CN": "产出 {yield} · 消耗 {cost} 体力"},

...
const UI_TEXT := {
	...
	"meta.hub.shop_tooltip": {"en": "Buy seeds, sell stock, and install restaurant upgrades.", "zh_CN": "购买种子、出售库存，并安装餐馆升级。"},
	...
	"meta.shop.seed_hint": {"en": "Buying a seed adds it permanently to the farm rotation.", "zh_CN": "购买种子后，会永久加入农场轮作。"},
	"meta.shop.sell_title": {"en": "Sell Stock", "zh_CN": "出售库存"},
	"meta.shop.sell_hint": {"en": "Sell one unit at a time to fine-tune the cash plan.", "zh_CN": "每次出售 1 份，用于细调现金规划。"},
	"meta.shop.upgrade_title": {"en": "Restaurant Upgrades", "zh_CN": "餐馆升级"},
	"meta.shop.upgrade_hint": {"en": "Permanent service bonuses for the existing daytime restaurant loop.", "zh_CN": "为现有白天餐馆循环提供永久营业加成。"},
	...
	"meta.bridge.summary_none": {"en": "Bring back rare night drops to open stronger daytime dishes, crops, and unlocks.", "zh_CN": "带回稀有夜间掉落，可开启更强的白天菜品、作物与解锁。"},
	...
	"meta.restaurant.subtitle": {"en": "Plan the menu, open service, and read the room.", "zh_CN": "安排菜单，开门营业，并观察顾客反馈。"},
	...
	"meta.restaurant.menu_hint": {"en": "Choose up to {max} recipes. Selected: {count}.", "zh_CN": "最多选择 {max} 道菜。当前已选 {count} 道。"},
	...
	"meta.restaurant.open_service_cost": {"en": "Open Service\nCost {value} actions", "zh_CN": "开始营业\n消耗 {value} 行动"},

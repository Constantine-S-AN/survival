...
const UI_TEXT := {
	...
	"meta.hub.subtitle": {"en": "Prepare the next descent.", "zh_CN": "为下一次夜晚出击做准备。"},
	...
	"meta.farm.subtitle": {"en": "Till plots, plant seeds, water crops, and harvest by day.", "zh_CN": "白天翻地、播种、浇水并收获作物。"},
	"meta.farm.stats": {"en": "Day {day} · Stamina {stamina}/{max}", "zh_CN": "第 {day} 天 · 体力 {stamina}/{max}"},
	...
	"meta.farm.tool_till": {"en": "Till\nCost 1 stamina", "zh_CN": "翻地\n消耗 1 体力"},
	"meta.farm.tool_water": {"en": "Water\nCost 1 stamina", "zh_CN": "浇水\n消耗 1 体力"},
	"meta.farm.tool_harvest": {"en": "Harvest", "zh_CN": "收获"},
	"meta.farm.tool_seed_detail": {"en": "Plant · {days} days · Cost {cost} stamina", "zh_CN": "播种 · {days} 天 · 消耗 {cost} 体力"},
	...
	"meta.restaurant.subtitle": {"en": "Cook meals into night-side bonuses.", "zh_CN": "把食材烹饪成夜间加成。"},
	"meta.restaurant.stats": {"en": "Day {day} · Stamina {stamina}/{max}", "zh_CN": "第 {day} 天 · 体力 {stamina}/{max}"},
	"meta.restaurant.inventory": {"en": "Inventory: {value}", "zh_CN": "库存：{value}"},
	...
	"meta.restaurant.status_ingredients": {"en": "Need: {value}", "zh_CN": "需要：{value}"},
	"meta.restaurant.status_bonus": {"en": "Prepared bonus: {value}", "zh_CN": "已准备加成：{value}"},
	"meta.restaurant.recipe_detail": {"en": "Needs {ingredients} · Cost {cost} stamina · Grants {bonus}", "zh_CN": "需要 {ingredients} · 消耗 {cost} 体力 · 提供 {bonus}"},
	"meta.restaurant.recipe_locked": {"en": "Unlock through the day/night economy.", "zh_CN": "通过昼夜循环经济解锁。"},
	...
	"meta.summary.rewards": {"en": "Rewards: +{gold} gold · {materials}\nNight bonus consumed: {bonus}", "zh_CN": "奖励：+{gold} 金币 · {materials}\n已消耗夜间加成：{bonus}"},

...
const UI_TEXT := {
	...
	"meta.restaurant.menu_hint": {"en": "Choose up to {max} recipes. Planned menus usually out-earn raw sales. Selected: {count}.", "zh_CN": "最多选择 {max} 道菜。规划好的菜单通常比原料直卖更赚钱。当前已选 {count} 道。"},

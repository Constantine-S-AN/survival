...
const UI_TEXT := {
	...
	"meta.hub.guide_body_day1": {"en": "The stall matters later, but Day 1 plays best as one clean lane: plots first, a Field Stew lunch proof next, then the dock. That first service is what gives tonight's night combat a real reason to matter tomorrow.", "zh_CN": "商店会很快变重要，但第 1 天最好按一条清晰路线来走：先种地，再用田园炖菜做出一轮午市证明，最后去码头。第一轮营业立住以后，今晚的夜战回报才会在明天真正显出意义。"},
	"meta.hub.guide_body_day2": {"en": "Night haul matters now. Spend that first return on unlock progress, cleaner service, or the next seed line before it just becomes storage.", "zh_CN": "夜里带回来的收获现在已经开始有分量了。优先把第一趟回来的东西花在解锁进度、更稳的营业，或下一条种子线，而不是只是堆进仓库。"},
	...
	"meta.hub.guide_focus_day1_dock": {"en": "The opening beat is set. Spend the last daylight cleanly, then leave from the pier with a reason to come back stronger tomorrow.", "zh_CN": "开场节奏已经立住了。把剩下的白天时间干净利落地收掉，然后带着“明天会更强”的理由从栈桥出航。"},
	"meta.hub.guide_focus_day2_water": {"en": "Touch the farm first. Water yesterday's crops before the rest of the day starts asking for your attention.", "zh_CN": "今天先碰农场。先把昨天种下的作物浇上水，再去处理其他会争抢你注意力的事。"},
	"meta.hub.guide_focus_day2_menu": {"en": "Last night's haul is on the table now. Lock a menu that actually spends it before the town scatters your actions.", "zh_CN": "昨晚带回来的东西现在已经摆上桌了。先定一份真正会花到它们的菜单，别让镇上的杂事把今天的行动切碎。"},
	"meta.hub.guide_focus_day2_service": {"en": "The pantry can carry this plan. Cash in the lunch shift before the rest of Day 2 turns back into errands.", "zh_CN": "库存已经能撑起这套计划。先把午市利润落袋，再让第 2 天重新散成一堆跑腿活。"},
	"meta.hub.guide_focus_day2_shop": {"en": "The day already paid once. Use the stall to turn margin and board rewards into the next seed line or fixture before evening.", "zh_CN": "今天已经先赚到一轮了。趁傍晚还没来，用补给摊把利润和公告板奖励继续滚成下一条种子线或厨房装置。"},
	"meta.hub.guide_focus_day3_harvest": {"en": "Harvest first. Day 3 only starts feeling powerful once those crops become today's stock, claims, and plated options.", "zh_CN": "先收成。只有等这波作物真的变成今天的库存、可领订单和上桌选择，第 3 天才会开始显得有力量。"},
	"meta.hub.guide_focus_day3_menu": {"en": "Fresh stock changes the whole day's math now. Decide what stays in storage, what gets sold, and what deserves a plate.", "zh_CN": "新鲜库存现在会直接改写整天的盘算。先决定哪些该留仓、哪些该卖掉、哪些值得上桌。"},
	"meta.hub.guide_focus_day3_service": {"en": "The harvest and the haul are finally talking to each other. Turn that overlap into plated dishes before the dock calls again.", "zh_CN": "收成和夜里带回来的东西终于开始互相接上了。趁码头再次催你之前，把这种重叠直接变成今天能卖掉的菜。"},
	"meta.hub.guide_focus_day3_route": {"en": "Route the whole loop with intent now: clean claims, spare-crop sales, stronger service, then keep tonight's dock window in sight.", "zh_CN": "现在开始要有意识地给整套循环排路线：先领顺手订单、处理多余作物、做更强的营业，然后继续把今晚的码头窗口放在眼里。"},
	"meta.hub.guide_focus_stock_check": {"en": "Menu is set. Check whether the pantry really supports it before you spend the rest of daylight elsewhere.", "zh_CN": "菜单已经定了。先确认库存真的撑得住，再把剩下的白天时间花到别处。"},
	"meta.hub.guide_orders": {"en": "Board leads: {value}.", "zh_CN": "今日公告板重点：{value}。"},
	...
	"meta.world.move_hint": {"en": "Move WASD / Arrows  |  Interact E  |  Tools 1-6 / Q", "zh_CN": "WASD / 方向键移动  |  E 互动  |  1-6 / Q 切换工具"},
	"meta.world.prompt_idle": {"en": "Walk up to a field, storefront, board, bench, or pier to see what is available there.", "zh_CN": "走到田地、店面、公告板、长椅或栈桥旁，就会看到那里能做什么。"},
	"meta.world.prompt_interact": {"en": "Press E at {value}.", "zh_CN": "按 E 使用 {value}。"},
	"meta.world.prompt_pickup": {"en": "Press E to gather {value}.", "zh_CN": "按 E 收集 {value}。"},
	"meta.world.prompt_farm_use": {"en": "Press E to use {value} on {target}.", "zh_CN": "按 E 对 {target} 使用 {value}。"},
	"meta.world.prompt_farm_harvest": {"en": "Press E to harvest {target}.", "zh_CN": "按 E 收获 {target}。"},
	"meta.world.prompt_farm_switch": {"en": "Switch to a farm tool to work {target}.", "zh_CN": "切换到农具后再处理 {target}。"},
	...
	"meta.world.prompt_orders_open": {"en": "Orders board open. Review contracts or press Esc to tuck it away.", "zh_CN": "订单板已打开。查看委托，或按 Esc 收起。"},
	"meta.world.pickup_collected": {"en": "Picked up {value}.", "zh_CN": "已收集 {value}。"},
	"meta.world.pickup_harbor_herb_name": {"en": "Harbor Herb", "zh_CN": "港边香草"},
	"meta.world.pickup_harbor_herb_summary": {"en": "A fresh herb patch by the fence. Handy for tea or early stew stock.", "zh_CN": "篱笆边长着一簇新鲜香草。拿去泡茶或炖汤都很合适。"},
	"meta.world.pickup_dock_scrap_name": {"en": "Dock Scrap", "zh_CN": "码头废料"},
	"meta.world.pickup_dock_scrap_summary": {"en": "Loose salvage washed up near the pier. Good night-kit filler if you grab it now.", "zh_CN": "栈桥边冲上来一包零散废料。现在捡走，晚上就能派上用场。"},
	...
	"meta.world.phase_cue_morning": {"en": "Fresh light over the harbor. Shops are opening and the farm still has full daylight.", "zh_CN": "港口晨光正好。商铺刚开门，农场也还有完整的白天。"},
	"meta.world.phase_cue_noon": {"en": "Midday bustle. This is the easiest window to route errands across town.", "zh_CN": "正午最热闹。现在最适合把镇上的事务顺路处理完。"},
	"meta.world.phase_cue_afternoon": {"en": "Longer shadows now. Wrap up daytime plans before the dock crew starts calling for night prep.", "zh_CN": "影子开始变长。最好在码头开始催夜间准备前收尾白天安排。"},
	"meta.world.phase_cue_evening": {"en": "Lanterns are up and the dock beacon is warming. The town is shifting toward night work.", "zh_CN": "路灯已经亮起，码头信标也在预热。镇子正慢慢切进夜间节奏。"},
	"meta.world.phase_cue_night": {"en": "The harbor is dark except for the dock lights. Sort the haul before the next day begins.", "zh_CN": "除了码头灯火外，港口已经暗下来。先把这趟带回来的收获整理好，再开始新的一天。"},
	"meta.world.restaurant_cue_day": {"en": "Dining room lights are ready. Plan dishes or open service while the town is still moving.", "zh_CN": "餐厅已经备好灯火。趁镇上还热闹时，去排菜单或开门营业。"},
	"meta.world.restaurant_cue_evening": {"en": "The room glows warmer now. Last daytime service decisions happen here before the descent.", "zh_CN": "餐厅灯色更暖了。下潜前最后一轮白天营业决定就在这里。"},
	"meta.world.restaurant_cue_night": {"en": "Kitchen row is quiet now. Service is done until the next day turns over.", "zh_CN": "夜里这排厨房已经安静下来。要等到明天翻页后，餐厅才会重新忙起来。"},
	"meta.world.shop_cue_day": {"en": "Supply stall is trading normally. Good time to buy seeds or clear true surplus stock.", "zh_CN": "补给摊照常营业。现在适合买种子，或处理真正富余的库存。"},
	"meta.world.shop_cue_evening": {"en": "Lanterns are on and foot traffic is thinning. Handle one last supply run before night.", "zh_CN": "摊位已经点灯，街上人也少了。下夜前还能做最后一轮补给。"},
	"meta.world.shop_cue_night": {"en": "The stall is shuttered for the night. Trading resumes after you roll into tomorrow.", "zh_CN": "摊位今晚已经打烊。要等到明天开始后才会重新营业。"},
	"meta.world.orders_cue": {"en": "Town requests refresh here. Check the board when you want structured side work.", "zh_CN": "镇上的委托会在这里刷新。想接有方向的支线活，就来看看公告板。"},
	"meta.world.orders_ready_cue": {"en": "{value} order reward(s) are ready to claim on the board.", "zh_CN": "公告板上有 {value} 份订单奖励可以领取。"},
	"meta.world.wait_cue_progress": {"en": "Sit here to roll the light forward. Evening is {value} action(s) away.", "zh_CN": "坐在这里可以把时间直接推进。距离傍晚还差 {value} 次行动。"},
	"meta.world.wait_cue_ready": {"en": "Evening is already here. The bench is just a quiet lookout now.", "zh_CN": "现在已经是傍晚了。这张长椅现在更像是个安静的瞭望点。"},
	"meta.world.night_cue_locked": {"en": "Dock gate sealed. Spend {value} more daytime action(s) before the night run opens.", "zh_CN": "码头闸门还锁着。还需要消耗 {value} 次白天行动，夜间出发点才会开放。"},
	"meta.world.night_cue_ready": {"en": "Dock beacon lit. Cast off from the pier to close out town time and begin the night run.", "zh_CN": "码头信标已经点亮。现在从栈桥出航，就会结束今天的镇上时段并开始夜间行动。"},
	"meta.world.night_confirm_title": {"en": "Cast Off", "zh_CN": "准备出航"},
	"meta.world.night_confirm_ready": {"en": "The skiff is trimmed, the dock crew is in place, and the harbor is ready to hand you over to the night sea.", "zh_CN": "小艇已经备好，码头上的人也都就位了。港口现在已经准备把你送进夜里的海面。"},
	"meta.world.night_confirm_note": {"en": "Casting off now ends Day {day}'s town phase from the {phase}. Farming, shopping, and service resume after you return.", "zh_CN": "现在出航会从{phase}直接结束第 {day} 天的镇上阶段。农场、商店和餐厅都要等你夜里回来后才会继续。"},
	"meta.world.night_confirm_launch": {"en": "Cast Off to Night Run", "zh_CN": "出航进入夜战"},
	"meta.world.night_confirm_cancel": {"en": "Hold Position", "zh_CN": "先留在岸上"},
	"meta.world.night_transition_title": {"en": "Harbor Falls Away", "zh_CN": "港口正在远去"},
	"meta.world.night_transition_body": {"en": "Mooring lines slip loose, the bow turns outward, and the night sea takes over.", "zh_CN": "缆绳松开，船头转向外海，夜里的海面开始接管这段行程。"},
	"meta.world.night_transition_note": {"en": "Town time is closed for Day {day}. Return with whatever the run gives back.", "zh_CN": "第 {day} 天的镇上时段已经收束。把这次夜间行动带回来的东西，再带回镇上。"},
	"meta.world.return_arrival_title": {"en": "Back at the Harbor", "zh_CN": "已经回到港口"},
	"meta.world.fresh_day_title": {"en": "Day {day} Begins", "zh_CN": "第 {day} 天开始"},
	"meta.world.fresh_day_meta": {"en": "Town doors are open again.", "zh_CN": "镇上的一天重新开始了。"},
	...
	"meta.world.legacy_hub": {"en": "Classic View", "zh_CN": "经典视图"},
	"meta.world.legacy_hub_tooltip": {"en": "Open the original panel layout for the daytime hub.", "zh_CN": "打开原始的面板式白昼据点。"},
	"meta.dialogue.reveal_hint": {"en": "E / Enter reveals the rest of the line", "zh_CN": "按 E / Enter 立刻显示整句对白"},
	"meta.dialogue.advance_hint": {"en": "E / Enter continues", "zh_CN": "按 E / Enter 继续"},
	"meta.dialogue.responses_hint": {"en": "Choose a response to continue", "zh_CN": "选择一个回应继续"},
	...
	"meta.day_hud.clock_title": {"en": "Day Clock", "zh_CN": "日间时钟"},
	"meta.day_hud.clock_phase_progress": {"en": "{phase} · {value} action(s) to evening", "zh_CN": "{phase} · 距离傍晚还差 {value} 次行动"},
	"meta.day_hud.clock_phase_ready": {"en": "{phase} · Evening reached", "zh_CN": "{phase} · 已进入傍晚"},
	"meta.day_hud.phase_track": {"en": "Morning  Noon  Afternoon  Evening", "zh_CN": "早晨  中午  下午  傍晚"},
	"meta.day_hud.departure_locked": {"en": "Night dock closed · {value} action(s) to dusk", "zh_CN": "夜间码头未开放 · 距离黄昏还差 {value} 次行动"},
	"meta.day_hud.departure_ready": {"en": "Night dock ready · Cast off ends the day", "zh_CN": "夜间码头已开放 · 出航会结束今天白天"},
	"meta.day_hud.hotbar": {"en": "Tools", "zh_CN": "工具"},
	"meta.day_hud.hotbar_hint": {"en": "1-6 pick  |  Q / Tab cycle  |  E work", "zh_CN": "1-6 选择  |  Q / Tab 切换  |  E 使用"},
	"meta.day_hud.hotbar_hand_short": {"en": "Hand", "zh_CN": "手"},
	"meta.day_hud.hotbar_hoe_short": {"en": "Hoe", "zh_CN": "锄"},
	"meta.day_hud.hotbar_water_short": {"en": "Can", "zh_CN": "壶"},
	"meta.day_hud.hotbar_hand_desc": {"en": "Hand equipped. Use this for doors, counters, pickups, and ripe crops.", "zh_CN": "当前为空手。适合处理门口、柜台、拾取物和成熟作物。"},
	"meta.day_hud.hotbar_hoe_desc": {"en": "Hoe equipped. Break empty ground into workable soil.", "zh_CN": "当前为锄头。把空地整理成可耕种的土壤。"},
	"meta.day_hud.hotbar_water_desc": {"en": "Watering can equipped. Water planted crops once per day.", "zh_CN": "当前为浇水壶。每天可为已种下的作物浇一次水。"},
	"meta.day_hud.hotbar_seed_desc": {"en": "Seed pouch ready. Plant {value} on tilled soil.", "zh_CN": "种子袋已准备好。可把 {value} 种在翻好的土地上。"},
	"meta.orders.title": {"en": "Daily Orders", "zh_CN": "每日订单"},
	"meta.orders.subtitle": {"en": "Orders refresh at the start of each new day. Finished unclaimed work pays out during rollover.", "zh_CN": "订单会在每天开始时刷新。已完成但未领取的工作会在跨天时自动结算。"},
	"meta.orders.subtitle_featured": {"en": "Orders refresh each morning. Today's opening leads: {value}.", "zh_CN": "订单会在每天早晨刷新。今天开场最值得盯住的委托是：{value}。"},
	"meta.orders.empty": {"en": "No orders are loaded yet.", "zh_CN": "当前还没有加载任何订单。"},
	"meta.orders.summary": {"en": "{active} active, {ready} ready to claim", "zh_CN": "当前 {active} 个进行中，{ready} 个可领取"},
	"meta.orders.summary_featured": {"en": "{active} active, {ready} ready to claim, {featured} featured", "zh_CN": "当前 {active} 个进行中，{ready} 个可领取，{featured} 个重点委托"},
	"meta.orders.badge_featured": {"en": "Opening lead", "zh_CN": "开场重点"},
	"meta.orders.claim": {"en": "Claim", "zh_CN": "领取"},
	"meta.orders.claim_failed": {"en": "Unable to claim {value} right now.", "zh_CN": "当前还不能领取 {value}。"},
	"meta.orders.claimed": {"en": "Claimed {value}.", "zh_CN": "已领取 {value}。"},
	"meta.orders.claimed_with_reward": {"en": "Claimed {name} for {reward}.", "zh_CN": "已领取 {name}，获得 {reward}。"},
	...
	"meta.shop.shopkeeper_line_day1": {"en": "Don't force the stall yet. Day 1 is mostly about remembering this counter turns tomorrow's margin into new seeds and fixtures.", "zh_CN": "今天不用急着硬逛商店。第 1 天更重要的是记住：明天的利润、种子线和升级，最后都会从这个柜台过手。"},
	"meta.shop.shopkeeper_line_day2": {"en": "Now the haul means something. Board rewards, seed starts, and cleaner lunch math all pass through this counter.", "zh_CN": "现在昨晚带回来的东西开始有分量了。公告板奖励、种子起手和更稳的午市盘算，最后都要从这个柜台过一遍。"},
	"meta.shop.shopkeeper_line_day3": {"en": "By day 3, this stall is where spare harvest and night margin get turned into the next route.", "zh_CN": "到了第 3 天，这个摊位就是把多余收成和夜里赚到的空间继续滚成下一段路线的地方。"},
	"meta.shop.shopkeeper_line_ready": {"en": "Board's moving today. You've got {value} order reward(s) ready once you check the contract board, and that's where the loop starts paying back fast.", "zh_CN": "今天公告板有动静。你去看一下委托板，就能领到 {value} 份订单奖励，而那正是整套循环开始快速回本的地方。"},
	...
	"meta.shop.customer_line_request_day1": {"en": "If you're already making the first loop, keep an eye on {value}. That's the kind of errand that decides whether tomorrow starts stocked or scrambling.", "zh_CN": "如果你正好在跑今天第一轮路线，顺手留意一下 {value} 吧。像这种差事，往往决定明天开场到底是库存充足还是手忙脚乱。"},
	"meta.shop.customer_line_request_day2": {"en": "{value} feels bigger today. Last night's return finally gave the board something real to push on.", "zh_CN": "{value} 今天会显得更有分量。昨晚那趟回来，终于让公告板有了值得真正发力的目标。"},
	"meta.shop.customer_line_request_day3": {"en": "By day 3, {value} is the kind of job that only works because your harvest and night stock are finally feeding each other.", "zh_CN": "到了第 3 天，像 {value} 这种工作之所以成立，就是因为你的收成和夜间库存终于开始互相供给了。"},
	...
	"meta.shop.customer_line_idle_day1": {"en": "Quiet first morning. Most people are still waiting to see whether your farm or your lunch counter gets moving first.", "zh_CN": "第一个早晨还算安静。大家更多是在看，你到底会先把农场跑起来，还是先把午市撑起来。"},
	"meta.shop.customer_line_idle_day2": {"en": "Different mood today. Once the first night haul lands, people start watching what you actually do with it.", "zh_CN": "今天气氛已经不一样了。只要第一趟夜里收获一落地，大家就会开始盯着你到底打算怎么花它。"},
	"meta.shop.customer_line_idle_day3": {"en": "Town's paying closer attention now. People can tell when the farm, the room, and the night run are finally feeding one another.", "zh_CN": "镇上的目光现在会更集中。大家已经能看出来，你的农场、餐馆和夜里那一趟是不是终于开始互相喂养了。"},
	...
	"meta.shop.inventory_more": {"en": "+{value} more stocked", "zh_CN": "另有 {value} 项库存"},
	...
	"meta.bridge.use_feedback": {"en": "{name} night edge", "zh_CN": "{name} 夜战优势"},
	"meta.bridge.feedback_ready": {"en": "{name}: {effect}", "zh_CN": "{name}：{effect}"},
	"meta.bridge.use_material.lumen_resin": {"en": "escort-route prep and shrine support reads", "zh_CN": "护送路线准备与神像支援判读"},
	"meta.bridge.use_material.coil_fragment": {"en": "market loadout tuning and device-stock reads", "zh_CN": "市场武装调校与装置货池判读"},
	"meta.bridge.use_material.challenge_seal": {"en": "high-risk route leverage for premium night plans", "zh_CN": "为高风险夜战路线准备更高价值筹码"},
	...
	"meta.summary.title": {"en": "Back at the Harbor", "zh_CN": "夜里回港"},
	"meta.summary.subtitle": {"en": "The skiff is in and the harbor crew is sorting the haul.", "zh_CN": "小艇已经靠岸，港口的人正在帮你整理这趟带回来的东西。"},
	"meta.summary.continue": {"en": "Step Into Day {day}", "zh_CN": "进入第 {day} 天"},
	"meta.summary.input_hint": {"en": "Press Enter or E to step into Day {day}.", "zh_CN": "按 Enter 或 E，进入第 {day} 天。"},
	...
	"meta.summary.outcome_extracted": {"en": "Night extracted. Secured haul banked before Day {next_day}.", "zh_CN": "夜晚提前撤离。已把稳稳到手的收获带回，并将进入第 {next_day} 天。"},
	...
	"meta.summary.tonight": {"en": "Tonight secured:\n{value}\nNight bonus converted: {bonus}", "zh_CN": "今晚带回：\n{value}\n已转化的夜间加成：{bonus}"},
	"meta.summary.relic_card": {"en": "Relics taken this run:\n{value}", "zh_CN": "本局拿到的遗物：\n{value}"},
	"meta.summary.carryover_card": {"en": "Dungeon carryover:\n{value}", "zh_CN": "这次地城真正带回来的东西：\n{value}"},
	"meta.summary.source_use_card": {"en": "Source -> daylight use:\n{value}", "zh_CN": "来源 -> 白天用途：\n{value}"},
	"meta.summary.source_use_line": {"en": "{source} -> {use}", "zh_CN": "{source} -> {use}"},
	"meta.summary.source_use_source": {"en": "{room}: {materials}", "zh_CN": "{room}：{materials}"},
	"meta.summary.source_use_stock": {"en": "{name} x{amount}", "zh_CN": "{name} x{amount}"},
	"meta.summary.source_use_none": {"en": "No strong daylight conversion yet.", "zh_CN": "暂时还没有更强的白天转化路径。"},
	"meta.summary.route_resource_card": {"en": "Route resource flow:\n{value}", "zh_CN": "路线资源流转：\n{value}"},
	"meta.summary.carryover_abandoned": {"en": "Emergency return only preserved the baseline salvage. Room-secure carryover was lost on the way out.", "zh_CN": "紧急返航只保住了基础打捞收益，房间里已经稳住的额外收获在撤离时还是丢掉了。"},
	"meta.summary.relic_line": {"en": "[{rarity}] {name}: {effect}", "zh_CN": "[{rarity}] {name}：{effect}"},
	"meta.summary.relic.rarity.rare": {"en": "Rare", "zh_CN": "稀有"},
	"meta.summary.relic.rarity.legendary": {"en": "Legendary", "zh_CN": "传说"},
	"meta.summary.route_resource_line": {"en": "{kind}: +{gain} / -{spend} / end {end}", "zh_CN": "{kind}：+{gain} / -{spend} / 结余 {end}"},
	"meta.summary.route_resource.kind.key": {"en": "Keys", "zh_CN": "钥匙"},
	"meta.summary.route_resource.kind.contract": {"en": "Contracts", "zh_CN": "契约"},
	"meta.summary.route_resource.kind.curse": {"en": "Curse", "zh_CN": "诅咒"},
	...
	"meta.summary.unlocks_card": {"en": "What opened because of tonight:\n{value}", "zh_CN": "今晚因此打开了什么：\n{value}"},
	"meta.summary.night_feedback_card": {"en": "Next-night edge:\n{value}", "zh_CN": "下一晚已经被打开的优势：\n{value}"},
	"meta.summary.night_feedback_line": {"en": "{name}: {effect}", "zh_CN": "{name}：{effect}"},
	"meta.summary.progress": {"en": "Unlock progress:\n{value}", "zh_CN": "解锁进度：\n{value}"},
	"meta.summary.progress_card": {"en": "Carryover progress:\n{value}", "zh_CN": "可延续到明天的进度：\n{value}"},
	...
	"meta.summary.condition_card": {"en": "What tomorrow feels like:\n{value}", "zh_CN": "明天开场的状态：\n{value}"},
	...
	"meta.summary.tomorrow_card": {"en": "Tomorrow opens with:\n{value}\nStorage now holds: {inventory}", "zh_CN": "明天开场最值得先做的事：\n{value}\n现在仓里已经有：{inventory}"},
	"meta.summary.tomorrow_farm": {"en": "The farm is the first strong lead. Night spores and seed-path progress can turn into fresh plots immediately.", "zh_CN": "农场会是明天最强的第一落点。夜里带回来的孢子和种植路径进度，马上就能变成新地块。"},
	"meta.summary.tomorrow_kitchen": {"en": "The kitchen is the first strong lead. Fresh night ingredients and recipe unlocks can go straight into service.", "zh_CN": "厨房会是明天最强的第一落点。夜里带回来的新食材和食谱解锁，马上就能进营业。"},
	"meta.summary.tomorrow_shop": {"en": "The shop becomes the first useful stop. Fresh gold and stock can convert into the next seed or upgrade.", "zh_CN": "商店会成为明天最有价值的第一站。新带回来的金币和库存，可以立刻换成下一步种子或升级。"},
	"meta.summary.tomorrow_mixed": {"en": "Tomorrow opens across both farm and kitchen. Check the haul first, then route it into plots or service.", "zh_CN": "明天会同时在农场和厨房两边打开机会。先看清这趟带回来的东西，再决定是投到地里还是投到营业里。"},
	"meta.summary.tomorrow_fatigue": {"en": "Start carefully. The haul is in storage, but next day stamina opens at {next}.", "zh_CN": "明天开场要收着一点。东西都已经进仓了，但可用体力只有 {next}。"},
	"meta.summary.tomorrow_generic": {"en": "The haul is already folded into storage, so tomorrow starts with more room to plan instead of recover.", "zh_CN": "这趟带回来的东西已经都并进仓里了，所以明天一开场更像是在规划下一步，而不是重新补救。"},
	...
	"meta.feedback.mycelium_broker.name": {"en": "Mycelium Broker", "zh_CN": "菌丝掮客"},
	"meta.feedback.mycelium_broker.effect": {"en": "Each night now starts with +1 Contract.", "zh_CN": "之后每一晚开局都会额外带 1 层契约。"},
	"meta.feedback.raw_bar_buyer.name": {"en": "Raw-Bar Buyer", "zh_CN": "生食买手"},
	"meta.feedback.raw_bar_buyer.effect": {"en": "Night markets lean rarer and refreshes cost 6 less XP.", "zh_CN": "夜战商店会更偏稀有 / 交易货，而且刷新少花 6 点经验。"},
	...
	"night.run.note.hidden_room_revealed": {"en": "Secret route revealed: {value}", "zh_CN": "隐藏路线已显现：{value}"},
	...
	"night.reward.kind.materials": {"en": "Materials", "zh_CN": "材料"},
	"night.reward.kind.upgrade": {"en": "Upgrade", "zh_CN": "强化"},
	"night.reward.kind.weapon": {"en": "Weapon", "zh_CN": "武器"},
	"night.reward.kind.blessing": {"en": "Blessing", "zh_CN": "祝福"},
	"night.reward.kind.weapon_trait": {"en": "Weapon Trait", "zh_CN": "武器词条"},
	"night.reward.kind.floor_mutator": {"en": "Floor Mutator", "zh_CN": "楼层变异"},
	"night.reward.kind.route": {"en": "Route Resource", "zh_CN": "路线资源"},
	"night.reward.kind.relic": {"en": "Relic", "zh_CN": "遗物"},
	"night.reward.kind.reward": {"en": "Reward", "zh_CN": "奖励"},
	"night.interaction.prompt.generic": {"en": "Press F to interact with {value}.", "zh_CN": "按 F 与 {value}互动。"},
	"night.interaction.prompt.shrine": {"en": "Press F to commune with {value}.", "zh_CN": "按 F 与 {value}共鸣。"},
	"night.interaction.prompt.shop": {"en": "Press F to browse {value}.", "zh_CN": "按 F 浏览 {value}。"},
	"night.interaction.prompt.breach": {"en": "Press F to breach the wall toward {value}.", "zh_CN": "按 F 炸开通往 {value} 的暗墙。"},
	"night.objective.prompt.hack": {"en": "Press F to hack {value}.", "zh_CN": "按 F 破解 {value}。"},
	"night.objective.prompt.reroute": {"en": "Press F to reroute {value}.", "zh_CN": "按 F 切换 {value}。"},
	"night.objective.prompt.cache": {"en": "Press F to unseal {value}.", "zh_CN": "按 F 解封 {value}。"},
	"night.interaction.panel_title.breach": {"en": "Hidden Breach", "zh_CN": "暗墙破口"},
	"night.interaction.panel_title.shrine": {"en": "Shrine Blessing", "zh_CN": "神像祝福"},
	"night.interaction.panel_title.shop": {"en": "Salvage Market", "zh_CN": "打捞黑市"},
	"night.interaction.panel_hint.breach": {"en": "Break the wall to expose the hidden chamber.", "zh_CN": "炸开暗墙，显露隐藏房间。"},
	"night.interaction.panel_hint.shrine": {"en": "Choose one blessing. The shrine asks for a price.", "zh_CN": "选择一个祝福。神像会索取代价。"},
	"night.interaction.panel_hint.shop": {"en": "Choose one item to buy with XP from this run.", "zh_CN": "选择一个商品，用本局经验购买。"},
	"night.interaction.cost.hp": {"en": "Cost: {value} HP", "zh_CN": "代价：{value} 生命"},
	"night.interaction.cost.noise": {"en": "Cost: +{value} noise", "zh_CN": "代价：+{value} 噪声"},
	"night.interaction.cost.curse": {"en": "Cost: +{value} curse", "zh_CN": "代价：+{value} 诅咒"},
	"night.interaction.cost.hp_or_noise": {"en": "Cost: {value} HP or +{value} noise", "zh_CN": "代价：{value} 生命或 +{value} 噪声"},
	"night.interaction.cost.xp": {"en": "Price: {value} XP", "zh_CN": "价格：{value} 经验"},
	"night.run.note.interaction_insufficient_xp": {"en": "Not enough XP for that purchase", "zh_CN": "经验不足，无法购买"},
	"night.run.note.interaction_paid_hp": {"en": "The shrine took {value} HP", "zh_CN": "神像收取了 {value} 点生命"},
	"night.run.note.interaction_paid_noise": {"en": "The shrine raised noise by {value}", "zh_CN": "神像使噪声提高了 {value}"},
	"night.run.note.interaction_paid_curse": {"en": "The shrine marked you with {value} curse", "zh_CN": "神像为你附加了 {value} 层诅咒"},
	"night.run.note.interaction_rejected": {"en": "You leave the shrine unanswered", "zh_CN": "你拒绝了神像的提议"},
	"night.objective.note.payload_started": {"en": "Hack started on {value}", "zh_CN": "开始破解 {value}"},
	"night.objective.note.payload_step_complete": {"en": "Payload terminal secured", "zh_CN": "载荷终端已接管"},
	"night.objective.note.relay_rerouted": {"en": "{value} rerouted", "zh_CN": "{value} 已切换"},
	"night.objective.note.cache_ready": {"en": "The cache seal broke open", "zh_CN": "缓存封印已破除"},
	"night.objective.note.cache_opened": {"en": "{value} opened", "zh_CN": "已开启 {value}"},
	"night.objective.note.checkpoint_secured": {"en": "Checkpoint secured", "zh_CN": "已稳住检查点"},
	"night.objective.note.failed_timer": {"en": "Objective failed: timer expired", "zh_CN": "目标失败：倒计时结束"},
	"night.objective.note.failed_integrity": {"en": "Objective failed: convoy integrity collapsed", "zh_CN": "目标失败：护送完整度耗尽"},
	"night.run.note.reward_already_owned": {"en": "Already carrying {value}", "zh_CN": "已经持有 {value}"},
	"night.run.note.relic_conflict": {"en": "{value} blocks that relic", "zh_CN": "{value} 会阻止这件遗物"},
	"night.run.note.route_resource_missing": {"en": "Route blocked: need {value}", "zh_CN": "路线受阻：需要 {value}"},
	"night.run.note.route_resource_missing_generic": {"en": "Route resource missing", "zh_CN": "缺少路线资源"},
	"night.route_resource.kind.key": {"en": "Key", "zh_CN": "钥匙"},
	"night.route_resource.kind.contract": {"en": "Contract", "zh_CN": "契约"},
	"night.route_resource.kind.curse": {"en": "Curse", "zh_CN": "诅咒"},
	"night.route_resource.amount": {"en": "{value} {kind}", "zh_CN": "{value} {kind}"},
	"night.route_resource.require": {"en": "Need: {value}", "zh_CN": "需求：{value}"},
	"night.route_resource.cost": {"en": "Spend: {value}", "zh_CN": "消耗：{value}"},
	"night.route_resource.gain": {"en": "Gain: {value}", "zh_CN": "获得：{value}"},

...
const UI_TEXT := {
	...
	"meta.hub.guide_body_day1": {"en": "Field Stew or Herb Tea are the cleanest first kitchen wins, and evening hands the whole loop over to night combat at the dock.", "zh_CN": "田园炖菜和香草茶是最干净的第一轮厨房胜利，而一到傍晚，整个循环就会在码头切进夜战。"},
	"meta.hub.guide_body_day2": {"en": "Night haul matters now: spend it on unlock progress, premium dishes, or the next seed line instead of letting it sit in storage.", "zh_CN": "现在夜间战利品已经开始决定节奏：优先把它们用在解锁进度、高价菜，或下一条种子路线，而不是一直堆在仓库里。"},
	"meta.hub.guide_body_day3": {"en": "Reef Salt, Glow Kelp, and Abyssfin are your first real loop amplifiers because they can turn fresh daylight into stronger payoffs.", "zh_CN": "Reef Salt、Glow Kelp 和 Abyssfin 是第一批真正能放大循环收益的夜间回报，因为它们能把白天的新机会直接抬高一档。"},
	...
	"meta.hub.guide_focus_day1_farm": {"en": "Starter plots first. Bank enough farm setup now that tomorrow's watering step feels automatic.", "zh_CN": "先把起手地块安排好。现在多铺一点农场进度，明天的浇水就会变成顺手动作。"},
	"meta.hub.guide_focus_day1_menu": {"en": "Farm setup is banked. Use the remaining daylight to pin Field Stew or Herb Tea before the dock takes over.", "zh_CN": "农场起手已经打底了。趁着剩余白天时间，把田园炖菜或香草茶先定下来，再交给码头接手。"},
	"meta.hub.guide_focus_day2_water": {"en": "Water yesterday's crops before the rest of the route pulls you sideways.", "zh_CN": "在其他路线把你带偏之前，先给昨天种下的作物浇水。"},
	"meta.hub.guide_focus_day2_menu": {"en": "Menu before motion. A dependable lunch shift still costs {value} actions, so lock it early.", "zh_CN": "先定菜单，再跑路线。一轮稳定午市仍然要花 {value} 次行动，所以越早定越好。"},
	"meta.hub.guide_focus_day2_service": {"en": "Menu is set and the pantry can carry it. Run the lunch shift before the remaining actions fragment.", "zh_CN": "菜单和库存都到位了。趁剩余行动还没被切碎，先把午市跑掉。"},
	"meta.hub.guide_focus_day2_shop": {"en": "Today's shift is settled. Turn the margin into the next seed, upgrade, or board payout before evening.", "zh_CN": "今天这轮营业已经落地了。傍晚前把这笔利润继续滚成下一颗种子、升级，或公告板收益。"},
	"meta.hub.guide_focus_day3_harvest": {"en": "Harvest first. Those crops decide today's pantry stock, easy order claims, and plated dishes.", "zh_CN": "先收成。今天的库存、顺手可领的订单，以及能上桌的菜，全看这波作物。"},
	"meta.hub.guide_focus_day3_menu": {"en": "Fresh stock changes the menu math. Decide what stays in the pantry and what becomes today's service plan.", "zh_CN": "新鲜库存会直接改写今天的菜单盘算。先决定哪些留在后厨，哪些变成今天的营业计划。"},
	"meta.hub.guide_focus_day3_service": {"en": "The harvest and night haul are both online now. Turn them into plated dishes before the dock starts calling again.", "zh_CN": "收成和夜间战利品现在都已经接上了。趁码头再次催你之前，把它们先变成今天能卖出去的菜。"},
	"meta.hub.guide_focus_day3_route": {"en": "Route the fresh stock now: claim the clean orders, sell the spare crop, and keep tonight's dock window in view.", "zh_CN": "现在就把新库存路线化：先领掉顺手订单，再卖掉多余作物，同时别忘了今晚的码头窗口。"},
	...
	"meta.orders.subtitle_featured": {"en": "Orders refresh each morning. Today's leads: {value}.", "zh_CN": "订单会在每天早晨刷新。今天的重点委托是：{value}。"},
	...
	"meta.orders.badge_featured": {"en": "Starter lead", "zh_CN": "新手重点"},

...
const UI_TEXT := {
	...
	"meta.world.move_hint": {"en": "WASD / Arrows move  |  E interact  |  1-6 select  |  Q / Tab cycle", "zh_CN": "WASD / 方向键移动  |  E 互动  |  1-6 选择  |  Q / Tab 切换"},
	...
	"meta.world.prompt_interact": {"en": "Press E to check {value}.", "zh_CN": "按 E 查看 {value}。"},
	...
	"meta.day_hud.departure_locked": {"en": "Night dock sealed · {value} action(s) to go", "zh_CN": "夜间码头未开放 · 还差 {value} 次行动"},
	"meta.day_hud.departure_ready": {"en": "Night dock ready · Beacon lit", "zh_CN": "夜间码头已开放 · 信标已点亮"},
	"meta.day_hud.hotbar": {"en": "Hotbar", "zh_CN": "快捷栏"},
	"meta.day_hud.hotbar_hint": {"en": "1-6 select  |  Q / Tab cycle  |  E use", "zh_CN": "1-6 选择  |  Q / Tab 切换  |  E 使用"},

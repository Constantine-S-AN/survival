...
const UI_TEXT := {
	...
	"meta.world.move_hint": {"en": "Move with WASD or the arrow keys. Press E to interact at an entrance.", "zh_CN": "使用 WASD 或方向键移动。站到入口处后按 E 互动。"},
	"meta.world.prompt_idle": {"en": "Walk to a district entrance. Nearby interact points glow when you are close enough.", "zh_CN": "走到各个区域入口旁。靠近后，可互动点会亮起。"},
	...
	"meta.world.prompt_orders_open": {"en": "Daily orders board open. Review contracts or press Esc to close it.", "zh_CN": "每日订单板已打开。查看委托，或按 Esc 关闭。"},
	...
	"meta.day_hud.orders": {"en": "Daily Orders", "zh_CN": "每日订单"},
	...
	"meta.day_hud.farm_tool_hint": {"en": "Q / Tab cycle  |  E use on a plot", "zh_CN": "Q / Tab 切换  |  E 对地块使用"},
